...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Tabel Pengarang</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  foreach ($data as $row) {?>
                    ...
                    <a href="<?= base_url()?>pengarang/hapus/<?= $row->id_pengarang;?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin ingin menghapus ?');">Hapus</a>
                    </td>
                    </tr>
                  <?php }
                  ?>
