...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Tabel Buku</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  foreach ($data->result() as $row) {?>
                    ...
                    <a href="<?= base_url()?>buku/hapus/<?= $row->id_buku;?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin ingin menghapus ?');">Hapus</a>
                    </td>
                    </tr>
                  <?php }
                  ?> 
