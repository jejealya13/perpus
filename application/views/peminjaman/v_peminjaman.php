...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Tabel Peminjaman</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  foreach ($data as $row) {
                    ...
                    <td>
                        <a href="<?= base_url()?>peminjaman/kembalikan/<?= $row->id_pm;?>" class="btn btn-primary btn-xs" onclick="return confirm('Yakin Buku ini ingin dikembalikan ?');"> Kembalikan</a>
                    </td>
                    </tr>
                  <?php }
                  ?> 
